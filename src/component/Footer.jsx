          ...
          <div>
            <h3 className="footer-title text-white">Social Links</h3>
                <div className="flex mx-auto gap-5">
                  <img className="border rounded-full h-10 w-10 p-2 bg-white" src="/products/Instagram.png" alt="instagram" />
                  <img className="border rounded-full h-10 w-10 p-2 bg-white" src="/products/Facebook.png" alt="facbook" />
                  <img className="border rounded-full h-10 w-10 p-2 bg-white" src="/products/x-twitter.png" alt="twitter" />
                </div>
          </div>
