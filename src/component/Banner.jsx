      ...
      <div className=" mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center relative z-12">
        ...
        <div className="space-y-4">
          <div className="inline-flex items-center gap-2 bg-zinc-600/10 border border-purple-500/30 text-purple-700 text-sm font-medium px-5 py-2 rounded-full">
            <img src="/products/bage-icon.png" alt=""/> New: AI-Powered Tools Available
          </div>
          ...
          <div className="flex flex-wrap gap-4 pt-4">
            <button className=" bg-indigo-600  hover:bg-purple-100 hover:text-purple-800 transition-all px-8 py-4 rounded-2xl font-semibold text-lg shadow-xl shadow-purple-500/30 flex items-center gap-3 group text-white cursor-pointer">
              Explore Products
            ...
            <span className="group-hover:translate-x-1 transition font-bold "><img src="/products/btn-icon.png" alt="" /></span>
              Watch Demo   
            </button>
          </div>
        </div>
